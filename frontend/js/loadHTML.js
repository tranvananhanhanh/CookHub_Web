...
//     // const createPostButtonLink = document.querySelector('.create-post-button'); // Nếu nút Create chính là thẻ a
...
//     //     if (createPostButton) createPostButton.style.display = 'flex';
//     // } else {
//     //     if (createPostButton) createPostButton.style.display = 'none';
//     // }

//     // const createPostButtonNav = document.getElementById('#nav-create-post-button');
//     // if (currentUserId === null) {
//     //     if (createPostButtonNav) createPostButtonNav.style.display = 'none';
//     // }
